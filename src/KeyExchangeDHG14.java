public class KeyExchangeDHG14 extends KeyExchange{
...
(byte)0xFF,(byte)0xFF,(byte)0xFF,(byte)0xFF,(byte)0xFF,(byte)0xFF,(byte)0xFF,(byte)0xFF
  ...
  public void init(Session session,
    ...
    try{
      sha=(HASH)LoadClass.getInstanceByConfig("sha-1");
      sha.init();
    }
    catch(Exception e){
        LoadClass.DebugPrintException("ex_93");
    ...
    try{
      dh=(KeyExchangeDH)LoadClass.getInstanceByConfig("dh");
      dh.init();
    }
    catch(Exception e){
        LoadClass.DebugPrintException("ex_94");
      throw e;
    }
